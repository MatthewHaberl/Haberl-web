...
export default async function ShopProductsPage() {
  ...
  const { data: catalog } = await fetchAllRowsParallel<{ id: string; cost_rands: number }>((from, to) =>
    supabase.from('equipment_catalog').select('id, cost_rands').order('id').range(from, to))
