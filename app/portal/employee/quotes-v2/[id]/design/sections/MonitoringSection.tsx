...
export function MonitoringSection() {
  ...
  return (
    <SectionCard
      ...
      action={
        <button type="button" onClick={add} className="flex items-center gap-1.5 rounded-md bg-primary px-2.5 py-1.5 text-xs font-semibold text-white hover:opacity-90">
