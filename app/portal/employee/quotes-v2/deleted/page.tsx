    ...
    <PageShell width="content">
      <div>
        ...
        <PageHeader
          ...
          description="Archived quotes, shrunk to the essentials. Admin-only. Restoring brings a quote back — re-open and recalculate to regenerate the printable version."
        />
      </div>
