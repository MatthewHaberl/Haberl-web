...
export interface EquipmentCatalogItem {
  ...
  pending?: boolean
  // Supplier dimension + structured attributes (migrations 051/091). Specs are
  // auto-extracted from the description text (amps, poles, AC/DC, voltage,
  // device_type, battery voltage class, …) with manual keys taking precedence.
...
/** Catalog-level compatibility link generated by the SANS rules engine (migration 092). */
