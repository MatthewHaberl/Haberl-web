import {
  ...
  Settings, UserCog, Ticket, CalendarDays, BookOpenCheck, HardHat, ReceiptText,
} from 'lucide-react'
...
export const PORTAL_SECTIONS = [
  ...
  { key: 'receipts',    label: 'Receipts',    description: 'Photograph the day’s slips from site — they land straight in Finance.', href: '/portal/employee/receipts',        match: '/portal/employee/receipts',       icon: ReceiptText,   defaultRoles: ALL_EMPLOYEE },
